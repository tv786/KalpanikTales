...
const appCss = "/assets/styles-ghaU2BAr.css";
...
function StarryBackground() {
  ...
  reactExports.useEffect(() => {
    ...
    const initStars = () => {
      stars = [];
      const numStars = Math.floor(canvas.width * canvas.height / 6e3);
      for (let i = 0; i < numStars; i++) {
        ...
        stars.push({
          ...
          opacity: Math.random(),
          opacitySpeed: Math.random() * 0.01 + 2e-3,
          color: isGold ? "200, 150, 12" : "255, 255, 255"
          // Gold or white
        });
      }
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 pointer-events-none z-[0] overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-transparent via-[rgba(200,150,12,0.03)] to-transparent dark:via-[rgba(200,150,12,0.05)] mix-blend-overlay" })
  ] });
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col items-center justify-center bg-transparent px-4 text-center", children: [
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-transparent px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex min-h-screen flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "bottom-right", richColors: true })
  ] });
}
const $$splitComponentImporter$h = () => import("./terms-C0nox8Pz.mjs");
const Route$i = createFileRoute("/terms")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Read the Terms & Conditions for using KalpanikTales, the home of mythological and folklore stories from Ancient Bharat."
    }]
  }),
...
const $$splitComponentImporter$g = () => import("./search-DPEowvuo.mjs");
const Route$g = createFileRoute("/search")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$f = () => import("./privacy-CtDvjaY-.mjs");
const Route$f = createFileRoute("/privacy")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Learn how KalpanikTales collects, uses, and protects your personal information. Your privacy matters to us."
    }]
  }),
...
const $$splitComponentImporter$e = () => import("./browse-Be_Fk-Ac.mjs");
...
const Route$e = createFileRoute("/browse")({
...
const $$splitComponentImporter$d = () => import("./auth-hGbi6Quo.mjs");
...
const $$splitComponentImporter$b = () => import("./index-BEBWvR_b.mjs");
...
const $$splitComponentImporter$a = () => import("./book._slug-Dtkroh18.mjs");
const Route$a = createFileRoute("/book/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component"),
  notFoundComponent: lazyRouteComponent($$splitNotFoundComponentImporter, "notFoundComponent"),
  errorComponent: lazyRouteComponent($$splitErrorComponentImporter, "errorComponent")
});
const $$splitComponentImporter$9 = () => import("./profile-CVzi-dno.mjs");
...
const $$splitComponentImporter$8 = () => import("./bookmarks-BpVgk31i.mjs");
const Route$8 = createFileRoute("/_authenticated/bookmarks")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./route-Cliu2xEH.mjs");
...
const $$splitComponentImporter$6 = () => import("./index-C9nFr1UL.mjs");
const Route$6 = createFileRoute("/_authenticated/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./read._bookSlug._chapterSlug-Cy6MsKpA.mjs");
const Route$5 = createFileRoute("/read/$bookSlug/$chapterSlug")({
  ssr: false,
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./users-DgdJ-P2V.mjs");
const Route$4 = createFileRoute("/_authenticated/admin/users")({
...
const $$splitComponentImporter$1 = () => import("../_bookId.index-Br0tlIO8.mjs");
const Route$1 = createFileRoute("/_authenticated/admin/$bookId/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_bookId._chapterId-yXQohniA.mjs");
...
const SearchRoute = Route$g.update({
  id: "/search",
  path: "/search",
  getParentRoute: () => Route$j
});
...
const BrowseRoute = Route$e.update({
  id: "/browse",
  path: "/browse",
  getParentRoute: () => Route$j
});
...
const BookSlugRoute = Route$a.update({
  id: "/book/$slug",
  path: "/book/$slug",
  getParentRoute: () => Route$j
});
...
const AuthenticatedBookmarksRoute = Route$8.update({
  id: "/bookmarks",
  path: "/bookmarks",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const ReadBookSlugChapterSlugRoute = Route$5.update({
  id: "/read/$bookSlug/$chapterSlug",
  path: "/read/$bookSlug/$chapterSlug",
  getParentRoute: () => Route$j
});
const AuthenticatedAdminUsersRoute = Route$4.update({
  id: "/users",
  path: "/users",
  getParentRoute: () => AuthenticatedAdminRouteRoute
});
