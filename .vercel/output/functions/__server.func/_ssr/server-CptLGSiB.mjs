...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-kaI2Tbot.mjs");
...
const manifest = {
  "ed3ceab58a919703a723479fbecac5a7d57863588d1ff985f9c8d6a6260910ba": {
    functionName: "listAdminUsers_createServerFn_handler",
    importer: () => import("./users.functions-De-TKnBn.mjs")
  },
  "0e9b8a18e7961a2b705a6ce9c7508d1b2ba0c69a04f5015a48eb872375110502": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C8_FFNj8.mjs").then((n) => n.r),
    import("./start-DoHil-qq.mjs"),
